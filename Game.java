    ...
    public void initializeBoard(){
        ...
        for(int i=0;i<noOfLadders;i++){
            while(true){
                ...
                String startend=String.valueOf(ladderStart)+String.valueOf(ladderEnd);
                if(!slpair.contains(startend)){
        ...
        while(true){
            ...
            if(newPos>board.getBoardSize()){
                ...
                if(player.getPosition()==board.getBoardSize()){
                    ...
                    player.getPosition(getNewPosition(newPos,player));
